  ...
  return {
    ...
    visitor: {
      ...
      ImportDeclaration: function ImportDeclaration(path) {
        ...
        path.node.specifiers.forEach(function (_ref4) {
          var importKind = _ref4.importKind;
      ...
      AssignmentPattern: function AssignmentPattern(_ref5) {
        var node = _ref5.node;

        node.left.optional = false;
      },
      Function: function Function(_ref6) {
        var node = _ref6.node;
